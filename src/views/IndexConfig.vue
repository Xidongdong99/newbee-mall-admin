<template>
  <el-card class="index-container">
    ...
    <el-table :load="state.loading" ref="multipleTable" :data="state.tableData" tooltip-effect="dark" style="width: 100%"
      ...
      <el-table-column prop="configRank" label="排序值" width="300">
      </el-table-column>
